...
if __name__=='__main__':
    ...
    logging.basicConfig(filename=f'g_map_scraper.log', filemode='w', level=logging.INFO)
    ...
    for city in cities:
        ...
        for keyword in keyword_list:
            ...
            for link in result_links: 
                try:  # if a business page takes too long to load, it throws exception when scraping the title
                    ...
                    logging.error(f'TimeoutException: skipping {link} in city {LOCATION["city"]} for keyword {keyword}:')
                    continue
        ...
        logging.warning(f'the {LOCATION["city"]} has been scraped properly!')
